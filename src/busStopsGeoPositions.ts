...
export const sortedNewBusStopPoints: point[] = [
  {
...
export const newBusStopsGeoPositions: point[] = [
  {
    "name": "St Hilda's Junior School",
    "position": {
      "coords": {
